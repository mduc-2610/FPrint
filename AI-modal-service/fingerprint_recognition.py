...
def update_fingerprint_model(segmentation_model_path_name="unet_segmentation_v1_0", 
                            recognition_model_path_name="siamese_network_v1_0"):
    """
    Update fingerprint recognition model from dataset
    This function automatically processes all fingerprint images in the fingerprint_adapting_dataset
    directory, creates embeddings, and updates the database.
    """
    ...
    # Check if existing embeddings database exists and load it
    ...
    for employee_id in os.listdir(dataset_dir):
        ...
        if os.path.isdir(employee_folder):
            ...
            if employee_embeddings:
                ...
                # Check for all-zero embeddings (potential issue)
